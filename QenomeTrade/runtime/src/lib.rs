...
use qenome::data_structure_rpc::MarketDataRpc;
use qenome::data_structure_rpc::ErrorRpc;
...
use qenome::data_structure_rpc::OrderbookRpc;
...
/// Import the qenome pallet.
pub use qenome;
use qenome::data_structure_rpc::LinkedPriceLevelRpc;
use qenome::data_structure_rpc::OrderbookUpdates;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-qenome"),
	impl_name: create_runtime_str!("node-qenome"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
...
// impl OnUnbalanced<NegativeImbalance<Self, SpendingAssetCurrency<Self>>> for DealWithFees {
// 	fn on_unbalanceds<B>(mut fees_then_tips: impl Iterator<Item=NegativeImbalance<Self, SpendingAssetCurrency<Self>>>) {
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Qenome: qenome::{Module, Call, Storage, Event<T>},
	}
);
